...
export const INITIAL_STUDENTS = [
  {
    ...
    mockSessions: [
      ...
      { id: 'mock-213-5', date: '2026-07-28', score: 10.0, evaluator: 'Mayukh', category: 'Behavioral', feedback: 'Passed final round! Flawless live coding & technical communication.', strengths: 'Complete tech mastery', improvement: 'None - Ready for job market' }
    ],
    stickyNotes: [
      {
        id: 'note-213-1',
  ...
  },
  {
    ...
    mockSessions: [
      ...
      { id: 'mock-212-4', date: '2026-07-29', score: 9.5, evaluator: 'Piyas', category: 'Practical', feedback: 'Flawless database sharding and caching strategy. Outstanding performer ready for tech rounds.', strengths: 'Distributed systems & sharding', improvement: 'Polishing verbal delivery' }
    ],
    stickyNotes: [
      {
        id: 'note-212-1',
