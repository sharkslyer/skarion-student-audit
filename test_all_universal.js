...
// Test universal speaker parser
const ALLOWED_EVALUATOR_NAMES = ['kasshaf', 'faisal', 'saki', 'ferdous', 'piyas', 'mayukh', 'tashfia'];
...
// Test on Mahbubul's transcript from initialData.js
